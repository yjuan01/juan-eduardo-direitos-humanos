...
Eles regem como as pessoas vivem em sociedade e definem as obrigações do Estado em relação a elas.
            ...
            {/* O bloco de citação precisa de uma classe CSS */}
          ...
          <section className={styles.contentSection} id="declaracao">
           ...
           <section className={styles.contentSection} id="curiosidades">
            ...
            <p>
              Acompanhe o desenvolvimento dos Direitos Humanos no mundo e entre em contato para mais informações.
            </p>
            <p>
                <strong>E-mail:</strong> contato@institutoforja.org.br
            </p>
          </section>
        ...
        <footer className={styles.footer}>
          ...
          <img src="/image/qrcode.svg" alt="" className={styles.footerImage} /> 
